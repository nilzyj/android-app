        ...
        btn_end.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(anim_num.isRunning())
				{
					...
					switch (count) {
						case 1:img_num.setImageResource(R.drawable.group1);break;
						case 2:img_num.setImageResource(R.drawable.group3);break;
						case 3:img_num.setImageResource(R.drawable.group2);break;
						case 4:img_num.setImageResource(R.drawable.group4);break;
						case 5:img_num.setImageResource(R.drawable.group5);break;
						case 6:img_num.setImageResource(R.drawable.group6);break;
					}
						if(stop==0)
							u=1-u;
						else
						...
						if(u==0)
						{
							pos+=count;text.setText(pos+"pos");
							if(pos>29)
								pos=58-pos;
							switch(pos)
							{
								...
								case 8:
									...
									break;
								case 10:pos=0;break;
								case 13:pos=13;stop=2;u=1;break;
								case 18:pos+=6;break;
								case 22:pos+=1;break;
								case 25:pos-=5;break;
								case 26:pos=29;break;
							}
						...
						{
							pos1+=count;text.setText(pos1+"pos1");
							if(pos1>29)
								pos1=58-pos1;
							...
							switch(pos1)
							{
								...
								case 8:
									...
									break;
								case 10:pos1=0;break;
								case 13:pos1=13;stop=2;u=0;break;
								case 18:pos1+=6;break;
								case 22:pos1+=1;break;
								case 25:pos1-=5;break;
								case 26:pos1=29;break;
							}
							if(pos1==29)
							{
								fun1("胖子");
